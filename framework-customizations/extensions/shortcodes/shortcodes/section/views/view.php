...
$collage_class = ( isset( $atts['is_collage'] ) && $atts['is_collage'] ) ? ' collage' : '';
$custom_class = ( isset( $atts['custom_class'] ) && $atts['custom_class'] ) ? '' . $atts['custom_class'] . '' : '';
$datas = ( isset( $atts['datas'] ) && $atts['datas'] ) ? ' ' . $atts['datas'] . '' : '';
?>
<section id="s_<?php echo $custom_class; ?>" class="fw-main-row <?php echo $custom_class; ?><?php echo $collage_class; ?>" <?php echo $section_style; ?> <?php echo $bg_video_data_attr; ?> <?php echo $datas; ?>>
